...
public class ModRecipeGenerator extends FabricRecipeProvider {
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RAW_PINK_GARNET)
                ...
                .criterion(hasItem(Items.STONE), conditionsFromItem(Items.STONE)) //makes recipe unlocked.
                        //if add stone to inventory then this recipe will unlock automaticalle
                .criterion(hasItem(ModItems.PINK_GARNET), conditionsFromItem(ModItems.PINK_GARNET))
                .offerTo(exporter, new Identifier(getRecipeName(ModItems.RAW_PINK_GARNET))); //recipe id, name of it
                    //recipe name is same as the actual thing getting generated, can also change that string for the json
